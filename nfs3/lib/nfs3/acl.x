...
struct nfsfattr {
	nfsftype na_type;	/* file type */
	uint64 na_mode;	/* protection mode bits */
	uint64 na_nlink;	/* # hard links */
	uint64 na_uid;		/* owner user id */
	uint64 na_gid;		/* owner group id */
	uint64 na_size;	/* file size in bytes */
	uint64 na_blocksize;	/* prefered block size */
	uint64 na_rdev;	/* special device # */
	uint64 na_blocks;	/* Kb of disk used by file */
	uint64 na_fsid;	/* device # */
	uint64 na_nodeid;	/* inode # */
	nfstime3 na_atime;	/* time of last access */
	nfstime3 na_mtime;	/* time of last modification */
	nfstime3 na_ctime;	/* time of last change */
};
