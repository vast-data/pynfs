...
class NFS3Client(rpc.RPCClient):
    ...
    def setattr(self, file_handle=None, mode_set=0, mode_val=0o777,
    ...
    def create(self, dir_fh=None, name=None, nfs3_mode=UNCHECKED,
               file_mode_set=0, file_mode_val=0o777, uid_set=0, uid_val=None,
    ...
    def mkdir(self, parent_fh=None, name=None,
              dir_mode_set=0, dir_mode_val=0o777, uid_set=0, uid_val=None,
              gid_set=0, gid_val=None, size_set=0, size_val=0,
              atime_set=0, atime_val=None, mtime_set=0, mtime_val=None):
        ### ToDo: add input validation?
        curr_time = ("%s" % time.time()).split('.')
    ...
    def symlink(self, dir_fh=None, link_name=None,
                mode_set=0, mode_val=0o777, uid_set=0, uid_val=None,
                gid_set=0, gid_val=None, size_set=0, size_val=0,
                atime_set=0, atime_val=None, mtime_set=0, mtime_val=None,
                data=None):
        ### ToDo: add input validation?
    ...
    def clean_dir(self, dir_fh):
        ...
        for e in entries:
            ...
            # e.name is bytes; e.name[0] would be an int in py3, so slice to keep it bytes
            if e.name[:1] != b'.':
